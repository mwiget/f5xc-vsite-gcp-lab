module "vsite2" {
  source                    = "./vsite"
  f5xc_vsite_name           = format("%s-gcp-vsite-2", var.project_prefix)
  ...
  gcp_slo_subnets         = [ "10.2.1.0/24", "10.2.2.0/24" ]
  gcp_sli_subnets         = [ "10.2.11.0/24", "10.2.12.0/24"]
  gcp_sli_workload_ip     = [ "10.2.11.100", "10.2.11.101" ]
